...
\thispagestyle{empty}
\begin{spacing}{1}
    \songti\sihao \hfill 密级：\underline{\makebox[4em]{公开}}
    ...
    \centering\textbf{\enskip 学\enskip 士\enskip 学\enskip 位\enskip 论\enskip 文}

    \centering\sihao\vspace{16pt}\textbf{\enskip THESIS\quad OF\quad BACHELOR}

    \centering\vspace{7pt} （20  —20  年）

    \quad\\
    \centering\vspace{7pt}\includegraphics[height=4.02cm, width=4.02cm]{pictures/NCU_sign}

    \vfill
    \sanhao\centering 题\hspace{1.5em}目\underline{\makebox[22em]{这只是一个论文标题而已}}

\end{spacing}
\begin{spacing}{2.15}
    \sihao\vspace{22pt}
    \begin{center}
        学\qquad 院：\underline{\makebox[8em]{软件学院}}\nobreak 系\underline{\makebox[8em]{软件工程}}\\
        专业班级：\underline{\makebox[17em]{软工XXX班}}\\
...
\phantomsection\addcontentsline{toc}{chapter}{摘要}
    ...
    \end{spacing}
    \begin{spacing}{2.41}
        \vspace{17pt minus 16.5pt}
        \centering
        \abszhname{摘要}
    \end{spacing}

    \vspace{16.5pt minus 16pt}\normalsize
{
这是中文摘要的部分。
...
\clearpage\phantomsection\addcontentsline{toc}{chapter}{结\qquad{}论}
\chapter*{结\qquad{}论}
\normalsize
